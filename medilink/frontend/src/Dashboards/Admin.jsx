  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Welcome back! Here's what's happening in your clinic network.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Clinic Registrations</h3>
          <Bar data={clinicRegistrations} options={{ responsive: true }} />
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Medicine Stock Levels</h3>
          <Line data={medicineStock} options={{ responsive: true }} />
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="p-4 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <p className="text-sm text-gray-600">Register a new clinic in the system</p>
          </button>
          <button className="p-4 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            <Users size={24} className="text-green-600 mb-2" />
            <p className="font-medium text-gray-900">Add Doctor</p>
            <p className="text-sm text-gray-600">Register a new doctor profile</p>
          </button>
          <button className="p-4 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            <Pill size={24} className="text-purple-600 mb-2" />
            <p className="font-medium text-gray-900">Add Medicine</p>
            <p className="text-sm text-gray-600">Add new medicine to inventory</p>
          </button>
        </div>
      </div>
    </div>
